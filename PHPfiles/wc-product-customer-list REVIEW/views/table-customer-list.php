...
if( ! function_exists('wpcl_post_class_meta_box') ) {
	function wpcl_post_class_meta_box( $object, $box )  {
		...
		if(get_option( 'wpcl_billing_company', 'no' ) == 'yes') { $columns[] = __('Billing Company', 'wc-product-customer-list'); }
		...
		if(get_option( 'wpcl_shipping_company', 'no' ) == 'yes') { $columns[] = __('Shipping Company', 'wc-product-customer-list'); }
		...
		if(get_option( 'wpcl_customer_username','no' ) == 'yes') { $columns[] = __('Customer username', 'wc-product-customer-list'); }
						...
						foreach( $item_sales as $sale ) {
							...
							// Order has been partially refunded
								...
								<tr>
									...
									<?php } ?>
									<?php if(get_option( 'wpcl_billing_company', 'no' ) == 'yes') { ?>
									<td>
										<p>
									...
									<?php } ?>
									<?php if(get_option( 'wpcl_shipping_company','no' ) == 'yes') { ?>
									<td>
										<p>
									...
									<?php } ?>
									<?php if(get_option( 'wpcl_customer_username','no' ) == 'yes') { ?>
									<td>
										<p>
											<?php 
									...
									<?php } ?>
									<?php if(get_option( 'wpcl_order_coupon','no' ) == 'yes') { ?>
									<td>
										<p>
											<?php
